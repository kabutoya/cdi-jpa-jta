...
//    }
//
//    private static abstract class AbstractTestableCompositeSpecification<T> implements CompositeSpecification<T> {
//
//        @Getter
//        protected final List<Specification<T>> components = new ArrayList<>(MAX);
//
//        @Override
...
//    }
//
//    private static class TestableCompositeSpecificationA1 extends AbstractTestableCompositeSpecification<String> {
//
//        @Override
...
//    }
//
//    private static class TestableCompositeSpecificationB1 extends AbstractTestableCompositeSpecification<String> {
//
//        @Override
//        public CompositeSpecification<String> with(Specification<String>... specifications) {
//            getComponents().addAll(Arrays.asList(specifications));
...
//    }
//
//    private static class TestableCompositeSpecificationC1 extends AbstractTestableCompositeSpecification<String> {
//
//        @Override
//        public CompositeSpecification<String> with(Specification<String>... specifications) {
...
//    }
//
//    private static class TestableCompositeSpecificationD1 extends AbstractTestableCompositeSpecification<String> {
//
//        @Override
//        public CompositeSpecification<String> with(Specification<String>... specifications) {
...
//    }
//
//    private static class TestableCompositeSpecificationE1 extends AbstractTestableCompositeSpecification<String> {
//
//        @Override
//        public CompositeSpecification<String> with(Specification<String>... specifications) {
